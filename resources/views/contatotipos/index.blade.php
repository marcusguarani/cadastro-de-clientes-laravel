            ...
            <div class="box-body">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Tipo de Contato</h3>
                    </div>
                    <div class="box-body">
                        ...
                        <table id="tb_contatotipos" class="table table-bordered table-striped table-hover">
                            <thead>
                                <tr>
                                    <th>Descrição</th>
                                    <th></th>
...
@section('js')
    ...
    <script>
        ...
        $(function () {
            ...
            $('#tb_contatotipos').DataTable({
                "ajax": "contatotipos/listar",
                "columns": [
                    {"data": "descricao"},
                ...
                "fnDrawCallback": function (oSettings) {
                    $(".grid-column-value-nowrap-button").on('click', 'button', function () {
                        var tipoId = $(this).val();
                        modal.open_n("contatotipos/show/" + tipoId, 'Editar Tipo de Contato', 40);
                    });
                }
            });

            $('#btn_novo_tipo').click(function () {
                modal.open_n("contatotipos/cadastrar", 'Novo Tipo de Contato', 40);
            });
